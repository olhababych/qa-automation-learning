...
"""
Тест Take Profit / Stop Loss для Short-позиції на SOLUSDC.
...
# SOL ~80: TP нижче ринку, SL вище — з запасом.
TP_PRICE = "30"
SL_PRICE = "200"
...
def test_open_short_with_tpsl_shows_in_position(
    ...
    """Short SOL з TP/SL: позиція відкривається, TP і SL підтверджені тостами."""
